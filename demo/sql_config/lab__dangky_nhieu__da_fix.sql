-- ==========================================================
-- Ten file : demo/sql_config/lab__dangky_nhieu__da_fix.sql
-- Module   : Dang ky hoc phan (TV3) — Chuong 4, muc 4.3 & 4.4
--
-- ✅ BẢN ĐÃ FIX (giữ nguyên 2 lần đọc, chỉ GIỮ mức cô lập mặc định REPEATABLE READ)
--
...
--     1. GIỮ mức cô lập mặc định REPEATABLE READ (✅ KHÔNG tắt phòng chống)
...
proc_dk_nhieu_lab: BEGIN
    ...
    -- ============================================================
    SET SESSION TRANSACTION ISOLATION LEVEL REPEATABLE READ;   -- ✅ GIU mac dinh
