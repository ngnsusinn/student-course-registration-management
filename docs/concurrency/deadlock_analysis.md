...
> **Tài liệu:** `docs/concurrency/deadlock_analysis.md`  
...
* Xem `docs/concurrency/isolation_level_analysis.md` (Issue #73) để hiểu vì sao `UPDLOCK+HOLDLOCK` trên 1 dòng là tối ưu.
...
Script `mysql/transactions/concurrency_test.sql` (Issue #74) có phần:
