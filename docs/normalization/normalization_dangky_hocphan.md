...
> **Tài liệu:** `docs/normalization/normalization_dangky_hocphan.md`
...
Script DDL chính thức (Issue #18 — `mysql/ddl/10_dangky_hocphan_ddl.sql`) thực thi đúng thiết kế 3NF trên:
